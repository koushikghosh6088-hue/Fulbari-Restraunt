...
export default function ContactPage() {
    const contactInfo = [
        { icon: Phone, title: "Phone", content: "+91 94327 50140 / +91 84206 80650", sub: "Mon-Sun from 12pm", delay: 0.1 },
                            ...
                            >
                                ...
                                <div className="relative z-10 space-y-4">
                                    ...
                                    <div className="pt-2 flex flex-col md:flex-row gap-4">
                                        <a href="tel:+919432750140" className="inline-flex items-center gap-2 bg-white text-primary px-6 py-3 rounded-full font-black uppercase text-xs tracking-widest hover:scale-105 transition-transform shadow-lg justify-center w-max">
                                            Call Primary <ArrowRight size={14} />
                                        </a>
                                        <a href="tel:+918420680650" className="inline-flex items-center gap-2 bg-white text-primary px-6 py-3 rounded-full font-black uppercase text-xs tracking-widest hover:scale-105 transition-transform shadow-lg justify-center w-max">
                                            Call Secondary <ArrowRight size={14} />
                                        </a>
                                    </div>
                                </div>
                            </motion.div>
