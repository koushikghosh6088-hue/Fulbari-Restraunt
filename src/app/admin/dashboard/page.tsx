                    ...
                    {showAddForm && (
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="space-y-2">
                                    <label className="text-sm font-medium text-muted-foreground">Dietary Type</label>
                                    <div className="flex bg-accent rounded-xl p-1 gap-1">
                                        <button
                                            type="button"
                                            onClick={() => setNewItem({ ...newItem, isVeg: true })}
                                            className={cn(
                                                "flex-grow py-2 px-4 rounded-lg text-sm font-bold transition-all flex items-center justify-center gap-2",
                                                newItem.isVeg ? "bg-green-500 text-white shadow-lg" : "text-muted-foreground hover:bg-white/5"
                                            )}
                                        >
                                        ...
                                        <button
                                            ...
                                            className={cn(
                                                "flex-grow py-2 px-4 rounded-lg text-sm font-bold transition-all flex items-center justify-center gap-2",
                                                !newItem.isVeg ? "bg-red-500 text-white shadow-lg" : "text-muted-foreground hover:bg-white/5"
                                            )}
                                        >
                                            <div className="w-3 h-3 border border-current rounded-sm flex items-center justify-center">
                                                <div className="w-1.5 h-1.5 bg-current rounded-full" />
                                            ...
                                            <div className="flex-grow">
                                                <div className="flex justify-between items-start mb-2">
                                                    <div className="flex flex-col">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <div className="shrink-0">
                                                                {item.isVeg ? (
                                                                    <div className="w-3 h-3 flex items-center justify-center border border-green-500 rounded-sm bg-white/5">
                                                                        <div className="w-1.5 h-1.5 bg-green-500 rounded-full" />
                                                                    </div>
                                                                ) : (
                                                                    <div className="w-3 h-3 flex items-center justify-center border border-red-500 rounded-sm bg-white/5">
                                                    ...
                                                    <div className="flex flex-col items-end gap-1">
                                                        <span className="text-[10px] uppercase font-bold text-primary px-2 py-0.5 bg-primary/10 rounded-full mb-1">{item.category}</span>
                                                        <div className="flex items-center gap-1">
                                                            <button
                                                                onClick={(e) => { e.stopPropagation(); handleEditItem(item); }}
                                                                className="p-1.5 rounded-lg bg-accent hover:bg-primary hover:text-white transition-all text-muted-foreground"
                                                                title="Edit Item"
                                                            >
                                                                <Pencil size={14} />
                                                            </button>
                                                            <button
                                                                ...
                                                                className="p-1.5 rounded-lg bg-accent hover:bg-red-500 hover:text-white transition-all text-muted-foreground"
                                                                title="Delete Item"
                                                            >
                                                                <Trash2 size={14} />
                                                            </button>
